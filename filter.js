...
const svgSB = d3.select("#sumburst").append("svg") 
    ...
    color = d3.scaleOrdinal(d3.quantize(d3.interpolateYlGnBu, root.height+2))
        .domain([80, 400])
        //.rangeRound([170, 0]);
    //d3.interpolateLab("steelblue", "brown")  //d3.interpolateViridis  //d3.interpolateMagma
    // d3.interpolateCividis // d3.interpolateGreens //interpolateYlGnBu //interpolateBlues
